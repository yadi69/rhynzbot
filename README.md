...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/rhynzid/rhynzbot)
...
```bash
git clone https://github.com/RhynzID/rhynzbot
cd stikerinbot
npm i
npm update
node .
